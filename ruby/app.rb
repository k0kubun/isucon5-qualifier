...
SQL
    ...
    entries_of_friends = []
    entries = db.query('SELECT * FROM entries ORDER BY id DESC LIMIT 1000').to_a
    etnries.each do |entry|
    ...
    comments_of_friends = []
    comments = db.query('SELECT * FROM comments ORDER BY id DESC LIMIT 1000').to_a
